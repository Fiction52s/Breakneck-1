...
struct Session : TilesetManager, QuadTreeCollider
{
	...
	void DrawPlayersToMap(sf::RenderTarget *target, bool drawKin, bool drawNameTags, bool minimap, float scale = 1.f);
...
//	void DrawBossHUD(sf::RenderTarget *target);
	...
	void DrawSurvivalTimers(sf::RenderTarget *target);
