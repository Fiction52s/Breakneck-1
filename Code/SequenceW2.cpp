...
BirdCrawlerAllianceTransitionScene::BirdCrawlerAllianceTransitionScene()
	:BasicBossScene(BasicBossScene::APPEAR)
{
	myBonus = NULL;
	if (sess->IsSessTypeGame())
	{
		...
		assert(myBonus == NULL);
		myBonus = game->CreateBonus("NewScenes/alliance");
	}
}
...
void BirdCrawlerAllianceTransitionScene::SetupStates()
{
	SetNumStates(Count);
...
void BirdCrawlerAllianceTransitionScene::ReturnToGame()
{
...
void BirdCrawlerAllianceTransitionScene::AddShots()
{
}

void BirdCrawlerAllianceTransitionScene::AddPoints()
{

}

void BirdCrawlerAllianceTransitionScene::AddFlashes()
{

}

void BirdCrawlerAllianceTransitionScene::AddEnemies()
{

}

void BirdCrawlerAllianceTransitionScene::AddGroups()
{
}

void BirdCrawlerAllianceTransitionScene::UpdateState()
{
	Actor *player = sess->GetPlayer(0);
	switch (seqData.state)
	{
