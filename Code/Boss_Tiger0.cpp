...
Boss_Tiger0::Boss_Tiger0( GameSession *owner, Edge *g, double q )
...
int Boss_Tiger0::NumTotalBullets()
{
	return 0;
}

void Boss_Tiger0::HandleEntrant( QuadTreeEntrant *qte )
{
	assert( queryMode != "" );
...
void Boss_Tiger0::HandleRayCollision( Edge *edge, double edgeQuantity, double rayPortion )
{
...
void Boss_Tiger0::UpdateHitboxes()
{
...
void Boss_Tiger0::ActionEnded()
{
}

double Boss_Tiger0::GetDistanceCCW( int index )
{
...
double Boss_Tiger0::GetDistanceClockwise( int index )
{
	Edge *e = bulletHits[index].edge;
	double q = bulletHits[index].quantity;
...
bool Boss_Tiger0::GetClockwise( int index )
{
	Edge *e = bulletHits[index].edge;
	double q = bulletHits[index].quantity;
...
void Boss_Tiger0::UpdatePrePhysics()
{
...
void Boss_Tiger0::UpdatePhysics()
{
...
bool Boss_Tiger0::ResolvePhysics( V2d vel )
{
	possibleEdgeCount = 0;
...
void Boss_Tiger0::PhysicsResponse()
{
	if( !dead  )
	{
		bool roll = mover->roll;
...
void Boss_Tiger0::UpdatePostPhysics()
{
...
bool Boss_Tiger0::PlayerSlowingMe()
{
	Actor *player = owner->player;
...
void Boss_Tiger0::Draw(sf::RenderTarget *target )
{
	if( !dead )
	{
...
void Boss_Tiger0::DrawMinimap( sf::RenderTarget *target )
{
	CircleShape cs;
	cs.setRadius( 50 );
...
void Boss_Tiger0::DebugDraw( RenderTarget *target )
{
	if( !dead )
	{
		//if( ground != NULL )
...
void Boss_Tiger0::SaveEnemyState()
{
}

void Boss_Tiger0::LoadEnemyState()
{
}

void Boss_Tiger0::HitTerrain( double &q )
{
	//useless
}
...
void Boss_Tiger0::BulletHitTerrain( BasicBullet *b,
...
void Boss_Tiger0::BulletHitPlayer( BasicBullet *b )
{
}

void Boss_Tiger0::HitTerrainAerial(Edge *edge, double q)
{
}

void Boss_Tiger0::TransferEdge( Edge *edge )
{
