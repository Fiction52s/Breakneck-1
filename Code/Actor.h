	...
	RayCastHandler, EnemyTracker
{
	...
	enum UpgradeType
	{
		...
		//22
		UPGRADE_W1_DECREASE_DRAIN_1,
		UPGRADE_W1_DECREASE_DRAIN_2,
		UPGRADE_W1_DECREASE_DRAIN_3,
		UPGRADE_W1_DECREASE_DAMAGE_1,
		UPGRADE_W1_DECREASE_DAMAGE_2,
		UPGRADE_W1_DECREASE_DAMAGE_3,
		UPGRADE_W1_INCREASE_REGEN_1,
		UPGRADE_W1_INCREASE_REGEN_2,
		...
		UPGRADE_W1_DASH_BOOST_HIGH_SPEED_3,
		UPGRADE_W1_INCREASE_STEEP_CLIMB_1,
		UPGRADE_W1_INCREASE_STEEP_CLIMB_2,
		UPGRADE_W1_INCREASE_STEEP_CLIMB_3,
		...
		//22
		UPGRADE_W2_DECREASE_DRAIN_1,
		UPGRADE_W2_DECREASE_DRAIN_2,
		UPGRADE_W2_DECREASE_DRAIN_3,
		UPGRADE_W2_DECREASE_DAMAGE_1,
		UPGRADE_W2_DECREASE_DAMAGE_2,
		UPGRADE_W2_DECREASE_DAMAGE_3,
		UPGRADE_W2_INCREASE_REGEN_1,
		UPGRADE_W2_INCREASE_REGEN_2,
		UPGRADE_W2_INCREASE_REGEN_3,
		UPGRADE_W2_DROP_FROM_CEILING_FAIR,
		UPGRADE_W2_INCREASE_PASSIVE_CEILING_ACCEL_1,
		UPGRADE_W2_INCREASE_PASSIVE_CEILING_ACCEL_2,
		UPGRADE_W2_INCREASE_PASSIVE_CEILING_ACCEL_3,
		UPGRADE_W2_INCREASE_CEILING_SPRINT_ACCEL_1,
		UPGRADE_W2_INCREASE_CEILING_SPRINT_ACCEL_2,
		UPGRADE_W2_INCREASE_CEILING_SPRINT_ACCEL_3,
		UPGRADE_W2_INCREASE_CEILING_STEEP_CLIMB_1,
		UPGRADE_W2_INCREASE_CEILING_STEEP_CLIMB_2,
		UPGRADE_W2_INCREASE_CEILING_STEEP_CLIMB_3,
		UPGRADE_W2_INCREASE_CEILING_STEEP_SLIDE_ACCEL_1,
		UPGRADE_W2_INCREASE_CEILING_STEEP_SLIDE_ACCEL_2,
		UPGRADE_W2_INCREASE_CEILING_STEEP_SLIDE_ACCEL_3,
		...
		UPGRADE_W3_DECREASE_DAMAGE_1,
		UPGRADE_W3_DECREASE_DAMAGE_2,
		UPGRADE_W3_DECREASE_DAMAGE_3,
		UPGRADE_W3_INCREASE_REGEN_1,
		UPGRADE_W3_INCREASE_REGEN_2,
		UPGRADE_W3_INCREASE_REGEN_3,
		...
		UPGRADE_W3_INCREASE_SPRINT_ACCEL_1,
		UPGRADE_W3_INCREASE_SPRINT_ACCEL_2,
		UPGRADE_W3_INCREASE_SPRINT_ACCEL_3,
		UPGRADE_W3_INCREASE_BOUNCE_STRENGTH_1,
		UPGRADE_W3_INCREASE_BOUNCE_STRENGTH_2,
		UPGRADE_W3_INCREASE_BOUNCE_STRENGTH_3,


		//22
		UPGRADE_W4_DECREASE_DRAIN_1,
		UPGRADE_W4_DECREASE_DRAIN_2,
		UPGRADE_W4_DECREASE_DRAIN_3,
		UPGRADE_W4_DECREASE_DAMAGE_1,
		UPGRADE_W4_DECREASE_DAMAGE_2,
		UPGRADE_W4_DECREASE_DAMAGE_3,
		UPGRADE_W4_INCREASE_REGEN_1,
		UPGRADE_W4_INCREASE_REGEN_2,
		UPGRADE_W4_INCREASE_REGEN_3,
		UPGRADE_W4_GRIND_LUNGE_SLASH_PROJECTILES,
		UPGRADE_W4_GRIND_LUNGE_REGRIND_KEEPS_SPEED,
		UPGRADE_W4_GRIND_ATTACK_BOOST_DIVE,
		UPGRADE_W4_GRIND_ATTACK_BOOST_DIVE_PROJECTILES,
		UPGRADE_W4_INCREASE_MOMENTUM_FROM_ENEMIES_1,
		UPGRADE_W4_INCREASE_MOMENTUM_FROM_ENEMIES_2,
		UPGRADE_W4_INCREASE_MOMENTUM_FROM_ENEMIES_3,
		UPGRADE_W4_INCREASE_START_MOMENTUM_1,
		UPGRADE_W4_INCREASE_START_MOMENTUM_2,
		UPGRADE_W4_INCREASE_START_MOMENTUM_3,
		UPGRADE_W4_INCREASE_BASE_DASH_1,
		UPGRADE_W4_INCREASE_BASE_DASH_2,
		UPGRADE_W4_INCREASE_BASE_DASH_3,

		//22
		UPGRADE_W5_DECREASE_DRAIN_1,
		UPGRADE_W5_DECREASE_DRAIN_2,
		UPGRADE_W5_DECREASE_DRAIN_3,
		UPGRADE_W5_DECREASE_DAMAGE_1,
		UPGRADE_W5_DECREASE_DAMAGE_2,
		UPGRADE_W5_DECREASE_DAMAGE_3,
		UPGRADE_W5_INCREASE_REGEN_1,
		UPGRADE_W5_INCREASE_REGEN_2,
		UPGRADE_W5_INCREASE_REGEN_3,
		...
		UPGRADE_W5_INCREASE_BUBBLE_SLOW_FACTOR_1,
		UPGRADE_W5_INCREASE_BUBBLE_SLOW_FACTOR_2,
		UPGRADE_W5_INCREASE_SLOW_RESISTANCE_1,
		UPGRADE_W5_INCREASE_SLOW_RESISTANCE_2,


		//22
		UPGRADE_W6_DECREASE_DRAIN_1,
		UPGRADE_W6_DECREASE_DRAIN_2,
		UPGRADE_W6_DECREASE_DRAIN_3,
		UPGRADE_W6_DECREASE_DAMAGE_1,
		UPGRADE_W6_DECREASE_DAMAGE_2,
		UPGRADE_W6_DECREASE_DAMAGE_3,
		UPGRADE_W6_INCREASE_REGEN_1,
		UPGRADE_W6_INCREASE_REGEN_2,
		UPGRADE_W6_INCREASE_REGEN_3,
		UPGRADE_W6_WIRE_ENEMIES_LEFT,
		UPGRADE_W6_WIRE_ENEMIES_RIGHT,
		UPGRADE_W6_MAX_SPEED_1,
		UPGRADE_W6_MAX_SPEED_2,
		UPGRADE_W6_MAX_SPEED_3,
		UPGRADE_W6_MAX_SPEED_4,
		UPGRADE_W6_MAX_SPEED_5,
		UPGRADE_W6_MAX_SPEED_6,
		UPGRADE_W6_MAX_SPEED_7,
		UPGRADE_W6_MAX_SPEED_8,
		UPGRADE_W6_INCREASE_BASE_AIRDASH_1,
		UPGRADE_W6_INCREASE_BASE_AIRDASH_2,
		UPGRADE_W6_INCREASE_BASE_AIRDASH_3,

		//9
		UPGRADE_W7_DECREASE_DRAIN_1,
		UPGRADE_W7_DECREASE_DRAIN_2,
		UPGRADE_W7_DECREASE_DRAIN_3,
		UPGRADE_W7_DECREASE_DAMAGE_1,
		UPGRADE_W7_DECREASE_DAMAGE_2,
		UPGRADE_W7_DECREASE_DAMAGE_3,
		UPGRADE_W7_INCREASE_REGEN_1,
		...
		//UPGRADE_W2_REVERSE_BOOST,
		//UPGRADE_W2_REVERSE_BOOST_HIGH_SPEED_1,
		//UPGRADE_W2_REVERSE_BOOST_HIGH_SPEED_2,
		//UPGRADE_W2_REVERSE_BOOST_HIGH_SPEED_3,
