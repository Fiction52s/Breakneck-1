...
struct ChooseRect : PanelMember
{
	...
	enum ChooseRectIdentity : int
	{
		...
		I_POST_MATCH_LEAVE,
		I_POST_MATCH_QUICKPLAY_VOTE_TO_KEEP_PLAYING,
...
enum ErrorType : int
{
	...
	ERR_CANT_SAVE_WHILE_PLAYTESTING,
...
struct ConfirmPopup : GUIHandler
{
	enum ConfirmType
	{
		...
		SAVE_CURRENT_OPEN,
		OVERWRITE_FILE,
		OVERWRITE_FILE_WITH_BLANK,
		OVERWRITE_FILE_AND_EXIT,
		OVERWRITE_FILE_WITH_BLANK_AND_EXIT,
		OVERWRITE_FILE_AND_OPEN,
		OVERWRITE_FILE_WITH_BLANK_AND_OPEN,
		OVERWRITE_FILE_AND_NEW,
		OVERWRITE_FILE_WITH_BLANK_AND_NEW,
		BACK_ALLOWED,
	};
