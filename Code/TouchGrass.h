...
struct TouchW2Plant : TouchGrass
{
	enum Action
	{
		STILL,
	...
	TouchW2Plant(TouchGrassCollection *coll, int index,
		Edge *e, double quant, int variation);
	void Reset();
	void Update();
	void Touch(Actor *a);
...
struct TouchW3Plant : TouchGrass
{
	enum Action
	{
		STILL,
	...
	TouchW3Plant(TouchGrassCollection *coll, int index,
		Edge *e, double quant, int variation);
	void Reset();
	void Update();
	void Touch(Actor *a);
