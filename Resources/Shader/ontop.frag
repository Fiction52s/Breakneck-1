...
{	
	...
	{
		pos = mod( topLeft + pixelPos + vec2( 0.0, -369.5 ), size) / vec2( size.x, size.y );
		//pos.y = pos.y - .5;
		pos.y = max( pos.y, .49 );
	...
	//vec4 col = vec4( 1.0 - gl_Color.r, 1.0-gl_Color.g, 1.0-gl_Color.b, gl_Color.a );
